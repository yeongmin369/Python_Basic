...
# Default Parameter
# - 만약에 함수 호출 시 입력해야 하는 parameter가 empty인 경우
# Default Parameter로 대체해 주는 기능!
...
# - return문 뒤에 오는 코드들은 실행 안 됨(Error X)
...
# 반대로 가장 산단에 정의되어 프로그램 종료 전까지 유지되는 변수를 전역 변수
# - 같은 이름의 지역변수, 전역변수 존재하는 경우 가까운(지역변수)가
# 우선순위가 더 높음

#num1 = 10 #전역 변수
#num2 = 20 #전역 변수

def test(num1, num2): #여기서 num은 지역 변수
    print(num1, num2)
    return num1 + num2
test(30, 40)
print(num1, num2)
...
# 2. global 키워드를 사용하는 방법(권장 x, 사용 금지)
a = 1
print(a)
